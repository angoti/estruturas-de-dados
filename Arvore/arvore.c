...
/* Uma árvore binária é formada de nós; 
...
int imprimeMenu() {
    ...
    printf("\n7- Profundidade");
    printf("\n8- Exibe o nó com o maior valor");
    printf("\n9- SAIR");
    printf("\n\n Digite a opção: ");
    scanf("%d",&op);
    return op;
...
void quantidadeDeNosNaArvore(raiz){
	
}

void somaDoConteudoDeTodosNos(raiz) { 
	
}

void profundidade(raiz){
	
}

void maiorValor(raiz){
  	...
  	while(1) {
	    ...
	    switch(op) {
	    	case 1 : system("cls");
       		...
       		case 7 : profundidade(raiz);
                  break;                 
            
       		case 8 : maiorValor(raiz);
                  break; 
